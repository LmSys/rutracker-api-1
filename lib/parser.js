...
class Parser {
    ...
    parsePage(rawHtml) {
        ...
        return new Torrent({
            ...
            id:         title.attr('href').replace(/.*?t=([0-9]*)$/g, '$1'),
            category:   category.text(),
            categoryId: category.attr('href').replace(/.*?f=([0-9]*)$/g, '$1'),
            title:      title.text(),
            author:     $('#topic_main').find('tbody:eq(1)').find('td:first').find('a:eq(1)').text(),
            size:       $('#tor-size-humn').text(),
